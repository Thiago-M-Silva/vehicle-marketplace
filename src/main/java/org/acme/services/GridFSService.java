...
public class GridFSService {
    ...
    /**
     * Retrieves a {@link GridFSBucket} instance for the "vehicleDocuments" bucket
     * in the "vehicle-marketplace" MongoDB database.
     *
     ...
     * <p>
     * Receives the filename, content type, and an InputStream of the file to be uploaded.
     * Configures upload options such as chunk size and metadata, then uploads the file
     * to the GridFS bucket and returns the generated ObjectId.
     * </p>
     *
     ...
     * <p>
     * Receives the vehicleId (filename) and an OutputStream to write the file data to.
     * Downloads the file from the GridFS bucket and writes it to the provided OutputStream.
     * </p>
     *
     ...
     * <p>
     * Receives the fileId (as a String) of the file to be deleted.
     * Converts the fileId to an ObjectId and deletes the corresponding file
     * from the GridFS bucket.
     * </p>
     *
     * @param fileId the String representation of the ObjectId of the file to be deleted
     */
