...
public class VehicleController {
     ...
     * @param vehicleType
     * @param id
     * @return a {@link Response} containing the vehicle data if found, or an
     ...
     * @param vehicleType
     * @param searchParams
     * @return a {@link Response} containing a list of vehicles matching the
     * search criteria if successful, or an error message with HTTP 400 status
     ...
     * @param vehicleType
     * @param vehicles
     * @return a {@link Response} with the number of vehicles saved if
     * successful, or an error message with HTTP 400 status if an exception
     * occurs.
     */
    @POST
     ...
     * @return a {@link Response} with the created vehicle if successful, or an
     * error message with HTTP 400 status if an exception occurs.
     */
    @POST
     ...
     *
     * @param vehicleType the type of vehicle to create (e.g., "car", "truck")
     * @param data a {@link VehicleDocumentRequestDTO} containing the vehicle
     * data and document file
     * @return a {@link Response} with the created vehicle if successful, or an
     * error message with HTTP 400 status if an exception occurs.
     */
    @POST
    ...
    /**
     * Handles HTTP DELETE requests to delete a vehicle by its unique identifier
     * and type.
     *
     * @param vehicleType
     * @param id
     * @return Response with HTTP 204 status if successful, or an error message
     * with HTTP 404 status if an exception occurs.
     */
    @DELETE
    ...
    /**
     * Handles HTTP DELETE requests to delete multiple vehicles by their unique
    ...
    /**
     * Handles HTTP PUT requests to edit a vehicle by its unique identifier and
     * type.
     *
     * @param vehicleType
     * @param id
